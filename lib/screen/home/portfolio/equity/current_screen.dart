...
class CurrentScreen extends StatefulWidget {
  ...
  CurrentScreen(String search) {  
    if (search == null) {
      _foundList = currentListPageBuildDesign;
    } else {
      _foundList = currentListPageBuildDesign
          .where((element) =>
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
          ...
          itemBuilder: (context, index) {
            return Padding(
              ...
              child: currentScreenListDesign(
                ...
                conText: widget._foundList[index]["conText"],
        ...
        // ),
        currentListPageBuildDesign.isNotEmpty
            ? Positioned(
                bottom: 10,
                right: 12,
                left: 12,
